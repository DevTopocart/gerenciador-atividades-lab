import { Button, Dialog, DialogContent, List, ListItem, Slide, Typography } from "@mui/material";
...
export default function VersionChecker() {
    ...
    return (<>
        ...
        >
            ...
            >
                <Typography variant="h3" textAlign={`center`} gutterBottom>Nova versão disponivel</Typography>

                <MuiMarkdown
                    overrides={{
                        ...getOverrides(),
                        h1: { component: Typography, props: { variant: "h6", gutterBottom: true, textAlign: 'center' } },
                        h2: { component: Typography, props: { variant: "h6", gutterBottom: true, textAlign: 'center' } },
                        h3: { component: Typography, props: { variant: "h5", gutterBottom: true, textAlign: 'center'} },
                        ...
                        li: {
                          component: ListItem,
                          props: { component: 'li', dense: true, style: { marginBottom: 4 } },
                        },
                      }}
                >
